              ...
              <div className="rounded-[2rem] border border-slate-200 bg-white p-7 shadow-sm">
                ...
                <div className="mt-5 space-y-3 text-sm text-slate-700">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-3">
                      <ChevronRight className="mt-[2px] h-4 w-4 shrink-0 text-slate-400" />
                      <div>Expanded the company nationwide</div>
                    </div>

                    <div className="flex gap-3">
                      <ChevronRight className="mt-[2px] h-4 w-4 shrink-0 text-slate-400" />
                      <div>
                        Led acquisition integrations and value creation initiatives
                        that delivered:
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="font-medium text-slate-900">
                        Family Owned and Operated → Private Equity → Public Company
                      </div>
                    </div>
                  </div>
                </div>
